...
const Skills = () => {
  ...
  return (
    <div className='flex-center flex-row w-full flex-wrap mt-12 paddings mx-auto gap-8'>
        {skills.map((skill) => (
            <div key={skill} className=' gap-4 w-full max-w-fit border-2 rounded-md p-2'>
