...
const CTA = () => {
  return (
    <section className="flex-center paddings w-full mt-52 z-10">
      ...
      <div className="relative flex-center flex-col paddings gap-16 w-[50rem] h-96 bgfooter2 border border-blue-700/40 rounded-xl">
        <div className="absolute flex-center w-full h-full bg-pixeles bg-center bg-cover bg-repeat bg-fixed"></div>
        <h1 className="md:heading2 xs:heading3 text-gradient-grey text-center leading-[10rem] z-[3] nonselect">
