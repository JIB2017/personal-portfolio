            ...
            <CardContent className="flex-start flex-row !p-0 gap-1 mt-4">
                {skills.map((skill) => (
                    ...
                    <div className="relative group">
                      ...
                      <span className="absolute opacity-0 p-2 text-black-400 bg-cyan-300 rounded group-hover:opacity-100 -translate-x-2 -translate-y-4 group-hover:translate-y-2 transition duration-300 nonselect">{skill}</span>
                    </div>
                    ))}
            </CardContent>
